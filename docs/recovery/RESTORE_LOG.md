...
| **Commit hash** | `b02809d` (initial restore); patch 2 pending commit |
...
| **Manual smoke result** | Re-test required — Weekly/Daily/Intraday hierarchy clicks, Lines/Hide toggles, zoom/pan RH/RL readability |
| **Commit hash** | pending |
